...
regarding the rectangle.py file.
"""
...
class TestRectangleInstantiation(unittest.TestCase):
    ...
    def OneArg_Test(self):
        with self.assertRaises(TypeError):
            Rectangle(1)

    def TwoArg_Test(self):
        r1 = Rectangle(10, 2)
        r2 = Rectangle(2, 10)
    ...
    def MoreThan_5_args_Test(self):
        with self.assertRaises(TypeError):
            Rectangle(1, 2, 3, 4, 5, 6)

    def Private_Width_Test(self):
        with self.assertRaises(AttributeError):
            print(Rectangle(5, 5, 0, 0, 1).__width)

    def Private_Weight_Test(self):
        with self.assertRaises(AttributeError):
            print(Rectangle(5, 5, 0, 0, 1).__height)

    def Private_x_test(self):
        with self.assertRaises(AttributeError):
            print(Rectangle(5, 5, 0, 0, 1).__x)

    def Private_y_Test(self):
        with self.assertRaises(AttributeError):
...
class TestRectangleWidthValidation(unittest.TestCase):
    ...
    def Float_Width_Test(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(5.5, 1)

    def Complex_width_Test(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(complex(5), 2)

    def Dict_Width_Test(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle({"a": 1, "b": 2}, 2)

    def Bool_Width_Test(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(True, 2)

    def List_Width_Test(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle([1, 2, 3], 2)

    def Set_Width_Test(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle({1, 2, 3}, 2)
...
class TestRectangleHeightValidation(unittest.TestCase):
    ...
    def None_height_Test(self):

        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            Rectangle(1, None)

    def Str_height_Test(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            Rectangle(1, "invalid")
...
class TestRectangleYValidation(unittest.TestCase):
    ...
    def ByteArray_y_Test(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(1, 2, 3, bytearray(b'abcdefg'))

    def MemoryView_y_Test(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
...
class TestRectangleOrderOfInitialization(unittest.TestCase):
    ...
    def Width_before_Height_Test(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle("invalid width", "invalid height")

    def Width_before_x_Test(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
...
class TestRectangle_stdout(unittest.TestCase):
    """A class used for Unittesting
    __str__ and display methods of Rectangle class."""

    @staticmethod
    def capture_stdout(rect, method):
        """used to capture and return
        text printed to stdout.

        Args:
            rect (Rectangle): represents the Rectangle.
            method (str): represents the method to run on rect.
        Returns:
    ...
    def Str_method_print_Width_Height_Test(self):
        rec = Rectangle(4, 6)
        cap = TestRectangle_stdout.capture_stdout(rec, "print")
        corr = "[Rectangle] ({}) 0/0 - 4/6\n".format(rec.id)
        self.assertEqual(corr, cap.getvalue())
...
class TestRectangleUpdateArgs(unittest.TestCase):
    ...
    def Update_args_Invalid_widthType_Test(self):
...
class TestRectangleUpdateKwargs(unittest.TestCase):
    ...
    def Update_Kwargs_one_Test(self):
        Rec = Rectangle(10, 10, 10, 10, 10)
        Rec.update(id=1)
    ...
    def Update_kwars_Three_Test(self):
        Rec = Rectangle(10, 10, 10, 10, 10)
    ...
    def Update_kwargs_None_Id_andMore_Test(self):
        Rec = Rectangle(10, 10, 10, 10, 10)
    ...
    def Update_kwargs_Height_zero_Test(self):
        Rec = Rectangle(10, 10, 10, 10, 10)
...
class TestRectangleToDictionary(unittest.TestCase):
    ...
    def to_dict_No_Object_changes_Test(self):
        r1 = Rectangle(10, 2, 1, 9, 5)
        r2 = Rectangle(5, 9, 1, 2, 10)
        r2.update(**r1.to_dictionary())
        self.assertNotEqual(r1, r2)

    def to_dict_arg_Test(self):
